...
from PySide6.QtWidgets import (QDateEdit, QGroupBox, QHBoxLayout, QLabel,
...
from ui.common.combo_helpers import (create_client_combobox,
                                     ...
                                     create_editable_combo, set_selected_by_id)
...
class PolicyForm(BaseEditForm):
    ...
    def __init__(
        ...
        *,                       # только именованные!
        ...
        super().__init__(instance=policy, model_class=Policy,
                         entity_name="полис", parent=parent)
    ...
    def collect_data(self) -> dict:
        ...
        for field in ["vehicle_brand", "vehicle_model", "sales_channel", "contractor", "insurance_company", "insurance_type"]:
    ...
    def save_data(self):
        ...
        if not data.get("end_date"):
            ...
            QMessageBox.warning(self, "Ошибка", "Дата окончания полиса обязательна для заполнения!")
            return None
        ...
        if self.instance:
            ...
            policy = add_policy(payments=payments, first_payment_paid=self._first_payment_paid, **data)
    ...
    def on_add_payment(self):
        ...
        self._draft_payments.append({
            "payment_date": date.toPython(),
            "amount": amount
        })
        row = self.payments_table.rowCount()
        self.payments_table.insertRow(row)
        self.payments_table.setItem(row, 0, QTableWidgetItem(date.toString("dd.MM.yyyy")))
    ...
    def add_payment_row(self, pay: dict):
        ...
        row = self.payments_table.rowCount()
        self.payments_table.insertRow(row)
        self.payments_table.setItem(row, 0, QTableWidgetItem(
