...
В таблицах доступна система «быстрых фильтров»: кликните правой кнопкой по иконке фильтра в заголовке столбца, чтобы ввести текст. Значения сохраняются между запусками и восстанавливаются автоматически.
