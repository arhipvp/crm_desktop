...
После запуска откроется вкладка **Главная** со сводной статистикой. В нижней части окна теперь отображается строка состояния с количеством записей в текущей таблице. В этой же вкладке можно увидеть дашборд с ближайшими задачами, заканчивающимися полисами и напоминаниями по сделкам.
