...
from database.models import Client, Deal, Income, Payment, Policy, Task
...
def test_db():
    ...
    main_db.bind([Client, Deal, Policy, Payment, Income, Task])
    main_db.connect()
    main_db.create_tables([Client, Deal, Policy, Payment, Income, Task])
    yield
