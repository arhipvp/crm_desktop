...
def add_policy(
    ...
    **kwargs,
    ...
    Аргумент ``payments`` передаётся только при необходимости: когда он
    отсутствует или пуст, сервис сам добавляет авто-нулевой платёж на дату
    начала полиса, чтобы сохранить ожидаемую структуру платежей.
    """
    # ────────── Клиент ──────────
